...
Usage:
    python ~/.gemini/scripts/checklist.py .                    # Run core checks
    python ~/.gemini/scripts/checklist.py . --url <URL>        # Include performance checks
...
CORE_CHECKS = [
    ...
    ("Test Runner", ".gemini/skills/testing-patterns/scripts/test_runner.py", False),
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python .gemini/scripts/checklist.py .                      # Core checks only
  python .gemini/scripts/checklist.py . --url http://localhost:3000  # Include performance
        """
    )
